...
@Component({
  selector: 'app-detalle-compras-c',
  templateUrl: './detalle-compras-c.component.html',
  styleUrls: ['./detalle-compras-c.component.css']
})
export class DetalleComprasCComponent implements OnInit {
